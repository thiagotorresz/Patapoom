...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden group">
      ...
      <div className="p-4">
        <div className="text-sm text-purple-600 capitalize mb-1">{product.category}</div>
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-md hover:bg-purple-700 transition-colors"
          >
            <FaWhatsapp size={20} />
            <span>Mensagem</span>
          </button>
